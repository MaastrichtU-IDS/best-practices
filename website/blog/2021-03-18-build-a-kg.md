...
* **Ontologies**: data models for knowledge graphs, they define classes and properties. e.g. https://schema.org/Restaurant
...
* **YARRRML**: a simplification of RML to define RML mappings in the popular YAML format, easier to define than the RML RDF.
