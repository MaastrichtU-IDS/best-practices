...
This tutorial will introduce what standard knowledge graphs are, and guide you to:
...
* Map 2 CSV files to a coherent RDF knowledge graph, and generate the RDF data
...
* [**YARRRML**](https://rml.io/yarrrml/spec/): a simplification of RML to define mappings in the popular human-readable [YAML format](https://yaml.org/), easier to write than the RML RDF.
